...
jq -r '
  select(
    ...
    (.requestReceivedTimestamp >= "2025-04-10T08:42:00.000000Z") and
    (.requestReceivedTimestamp <= "2025-04-10T09:12:00.000000Z")
  ) | .verb' /var/log/kubernetes/audit/audit.log | sort | uniq -c | sort -nr

  jq -r '
  select(
    (.requestReceivedTimestamp >= "2025-04-10T08:41:00.000000Z") and
